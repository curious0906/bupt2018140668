...
<div class="container" style="border: 1px solid #CCCCCC;height: 1000px;">
    ...
    <form class="form-horizontal" role="form" id="storeForm" method="post" action="merchants/user/addition">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="password" class="form-control" id="password" name="password" value="${user.userPassword}" placeholder="密码">
            </div>
            <span></span>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select class="form-control" name="roleIds" id="roleIds" multiple="multiple" style="width: 150px;">
                    <c:forEach items="${allRoles}" var="role">
                        <option value="${role.characterId}">${role.characterName}</option>
                    </c:forEach>
                </select>
