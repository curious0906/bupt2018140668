...
<div class="container" style="border: 1px solid #CCCCCC;height: 1000px;">
    ...
    <form class="form-horizontal" role="form" id="storeForm" method="post" action="admin/role/edit">
        <input type="hidden" name="roleId" value="${role.characterId}">
        <div class="form-group">
            <label for="name" class="col-sm-2 control-label">角色名称：</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" id="name" name="name" value="${role.characterName}" placeholder="角色名称">
            </div>
            <span></span>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="code" name="code" value="${role.characterCode}" placeholder="角色代码">
            </div>
            <span></span>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="description" name="description" value="${role.characterDescription}" placeholder="角色描述">
            </div>
            <span></span>
        </div>
