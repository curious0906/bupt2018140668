                    ...
                    <tr class="cart_item" id="cart_item${cartItem.value.bookInfo.bookId}">
                        <td class="tcol1">
                            <input type="checkbox" ${cartItem.value.checked?'checked':''}
                                   onchange="checkOrNot(${cartItem.value.bookInfo.bookId},${cartItem.value.bookInfo.bookPrice},this)"
                                   class="shop_checkbox"/>
                        </td>
                        <td>
                            <a href="#"><img src="${cartItem.value.bookInfo.bookImageUrl}" width="20%"/></a>
                            <span>${cartItem.value.bookInfo.bookName}</span>
                        </td>
                        <td>
                            <span class="red">￥<fmt:formatNumber type="number" value="${cartItem.value.bookInfo.bookPrice}"
                                                                 pattern="0.00"/></span>
                        </td>
                        <td>
                            <div class="num">
                                ...
                                <a href="javascript:void(0);" class="num_add"
                                   onclick="add(${cartItem.value.bookInfo.bookId},${cartItem.value.bookInfo.bookPrice})"></a>
                                <a href="javascript:void(0);" class="num_sub"
                                   onclick="sub(${cartItem.value.bookInfo.bookId},${cartItem.value.bookInfo.bookPrice})"></a>
                            </div>
                        </td>
                        <td>
                            <span class="red">￥</span>
