...
<div class="container" style="border: 4px solid #f5f5f5;">
    <div class="tip_div">
        ...
        <c:if test="${bookInfo != null}">
            ...
            <div class="things">
                ...
                <span>${cart.cartItems[bookInfo.bookId].buyNum}</span>
            </div>
    ...
    <div class="next_div">
        <a href="cart/items?bookId=${bookInfo.bookId}&buyNum=${cart.cartItems[bookInfo.bookId].buyNum}" class="toCart">去购物车结算</a>
