            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="address" name="detailAddress"
                           value="${sessionScope.loginUser.userDetailAddress}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputPassword3" name="username"
                           placeholder="请确认收货人" value="${sessionScope.loginUser.userUsername}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="confirmPassword" name="phone"
                           placeholder="请输入联系方式" value="${sessionScope.loginUser.userPhone}">
                </div>
            </div>
        </div>
