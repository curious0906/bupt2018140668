...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            jQuery.validator.addMethod("isMo bile", function(value, element) {
...
<div class="container">
    <form class="form-horizontal" action="user/update" role="form" id="userInfoForm" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <p class="form-control-static">${sessionScope.loginUser.userUsername}</p>
            </div>
        </div>
        ...
        <div class="form-group" style="margin-left: -33px;">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="nickname" id="nickname"
                       value="${sessionScope.loginUser.userNickname}" placeholder="昵称">
            </div>
        </div>
        ...
        <div class="form-group" style="margin-left: -33px;">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="phone" id="phone"
                       value="${sessionScope.loginUser.userPhone}" placeholder="电话号码">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="location" id="location" style="width: 150px;">
                ...
                <option value="广州" ${sessionScope.loginUser.userAddress == "广州"? "selected":""} >广州</option>
                <option value="北京" ${sessionScope.loginUser.userAddress == "北京"? "selected":""}>北京</option>
                <option value="上海" ${sessionScope.loginUser.userAddress == "上海"? "selected":""}>上海</option>
                <option value="深圳" ${sessionScope.loginUser.userAddress == "深圳"? "selected":""}>深圳</option>
                <option value="茂名" ${sessionScope.loginUser.userAddress == "茂名"? "selected":""}>茂名</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <label class="radio-inline">
                <input type="radio" name="gender" id="man"
                       value="1" ${sessionScope.loginUser.userGender == "1"? "checked":""} > 男
            </label>
            <label class="radio-inline">
                <input type="radio" name="gender" id="woman"
                       value="0" ${sessionScope.loginUser.userGender == "0"? "checked":""} > 女
            </label>
        </div>
        ...
        <div class="form-group">
            ...
            <label class="radio-inline">
                <input type="radio" name="identity" id="student"
                       value="学生" ${sessionScope.loginUser.userIdentity == "学生"? "checked":""}> 学生
            </label>
            <label class="radio-inline">
                <input type="radio" name="identity" id="teacher"
                       value="教师" ${sessionScope.loginUser.userIdentity == "教师"? "checked":""}> 教师
            </label>
            <label class="radio-inline">
                <input type="radio" name="identity" id="worker"
                       value="上班族" ${sessionScope.loginUser.userIdentity == "上班族"? "checked":""}> 上班族
            </label>
            <label class="radio-inline">
                <input type="radio" name="identity" id="liberal"
                       value="自由职业" ${sessionScope.loginUser.userIdentity == "自由职业"? "checked":""}> 自由职业
            </label>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="detailAddress" id="detailAddress"
                       value="${sessionScope.loginUser.userDetailAddress }" placeholder="详细住址:">
            </div>
        </div>
