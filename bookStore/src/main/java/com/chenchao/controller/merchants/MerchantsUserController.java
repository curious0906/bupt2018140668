...
public class MerchantsUserController {
...
//    @RequiresPermissions("user-edit")
    public String echo(@PathVariable("userId") int userId, Model model){
        ...
        return "merchants/user/merchants_edit";
    }
...
//    @RequiresPermissions("user-edit")
    public String updateUser(Users user, int[] roleIds, Model model){
        ...
        return "forward:/merchants/user/echo/"+user.getUserId();
    }
...
//    @RequiresPermissions("user-list")
    public String userList(Model model){
        ...
        return "merchants/user/merchants_list";
    }
...
//    @RequiresPermissions("user-add")
    public String toAddition(Model model){
        ...
        return "merchants/user/merchants_add";
    }
