...
class FeedFowardNetwork(tf.keras.layers.Layer):
    ...
    def __init__(self, hidden_size, filter_size, relu_dropout, allow_pad=False):
    ...
    def call(self, x, training=None, padding=None):
        ...
        if training is not None:
            output = tf.keras.layers.Dropout(self.relu_dropout)(output)
