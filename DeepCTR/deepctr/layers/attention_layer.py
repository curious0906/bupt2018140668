...
class Attention(tf.keras.layers.Layer):
    ...
    def call(self, x, y, bias=None, training=None, cache=None):
        ...
        if training is not None:
            weights = tf.keras.layers.Dropout(self.attention_dropout)(weights)
...
class SelfAttention(Attention):
    ...
    def call(self, x, bias, training=None, cache=None):
